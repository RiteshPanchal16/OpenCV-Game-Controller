...
haiding = Label(text="OpenCV Game Controller")
haiding.pack()

image = Image.open("E:\my program\python\Racecar.jpg")
image=image.resize((600,300),Image.ANTIALIAS)
photo=ImageTk.PhotoImage(image,size=50)
...
frame = Frame(root)
frame.pack()
button = Button (frame,bg="black",fg="white", text = "Run",padx=40, command = close_window)
button['font'] = myFont
